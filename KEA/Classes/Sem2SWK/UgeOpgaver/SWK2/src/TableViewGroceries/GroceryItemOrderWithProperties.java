...
public class GroceryItemOrderWithProperties{

    private SimpleStringProperty name;
    private SimpleIntegerProperty quantity;
    private SimpleDoubleProperty pricePerUnit;

    public GroceryItemOrderWithProperties(String name, int quantity, double pricePerUnit) {
        this.name = new SimpleStringProperty(name);
        this.quantity = new SimpleIntegerProperty(quantity);
        this.pricePerUnit = new SimpleDoubleProperty(pricePerUnit);
    }

    public GroceryItemOrderWithProperties(String name) {
        this(name, 1, 0.0);
    }
