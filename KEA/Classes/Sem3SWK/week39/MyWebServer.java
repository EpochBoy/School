...
public class MyWebServer {
    public static void main(String[] args) {
        try {
            ...
            String serverPath = "/Users/forneus/Dropbox/Datamatiker/3. Semester/GITSem3Alexandru/src/dk/kea/swc3/week40/kea-dat15b-web";
            int port = 8080;
            ...
            while (true) {
                ...
                if (msg.toUpperCase().startsWith("GET")) {
                    ...
                    try {
                        ...
                        out.writeBytes("HTTP/1.1 404 Shit not found\r\n");
                        e.printStackTrace();
                        //return; Alex siger return er overflødig
                    }
